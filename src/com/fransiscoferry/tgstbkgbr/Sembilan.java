package com.fransiscoferry.tgstbkgbr;
...
public class Sembilan extends Activity {
	EditText jawabantxt;
	@Override
	...
	public void cek(View v){
    	String jawabanBenar = "TANGAN BESI";
    	...
    	if(jawabanUser.equals(jawabanBenar)){
    		...
    		Intent i = new Intent(getApplicationContext(),Sepuluh.class);
    		startActivity(i);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.sembilan, menu);
		return true;
	}
